 ...
 * })
 */
readers.readData = function (filePath, opts_, cb_) {
  ...
  if (arguments.length === 3) {
    if (opts_.parser) {
      ...
      parser = helpers.discernParser(filePath)
    }
  ...
  fs.readFile(filePath, 'utf8', function (err, data) {
    if (equivalentFormats.json.indexOf(helpers.discernFormat(filePath)) > -1 && data === '') {
      data = '[]'
    }
    if (err) {
      cb(err)
    ...
    try {
      if (_.isFunction(parser)) {
        ...
        err = 'Your specified parser is not properly formatted. It must either be a function or have a `parse` method.'
      }
    } catch (err) {
      cb(err)
      return
 ...
 * console.log(data) // Json data with any number values multiplied by two and errors reported with `fileName`
 */
readers.readDataSync = function (filePath, opts_) {
  var parser
  var parserOptions
 ...
 * })
 */
shorthandReaders.readCsv = function (filePath, opts_, cb) {
  var parserOptions
  if (typeof cb === 'undefined') {
    cb = opts_
  } else {
  ...
  readers.readData(filePath, {parser: parsers.csv, parserOptions: parserOptions}, cb)
}
 ...
 */
shorthandReaders.readCsvSync = function (filePath, opts_) {
  var parserOptions
  if (typeof opts_ !== 'undefined') {
    parserOptions = _.isFunction(opts_) ? {map: opts_} : opts_
  }
  return readers.readDataSync(filePath, {parser: parsers.csv, parserOptions: parserOptions})
}
 ...
 * })
 */
shorthandReaders.readJson = function (filePath, opts_, cb) {
  var parserOptions
  if (typeof cb === 'undefined') {
    cb = opts_
  } else {
  ...
  readers.readData(filePath, {parser: parsers.json, parserOptions: parserOptions}, cb)
}
 ...
 * console.log(data) // Json data with any number values multiplied by two and errors reported with `fileName`
 */
shorthandReaders.readJsonSync = function (filePath, opts_) {
  var parserOptions
  if (typeof opts_ !== 'undefined') {
    parserOptions = _.isFunction(opts_) ? {map: opts_} : opts_
  }
  return readers.readDataSync(filePath, {parser: parsers.json, parserOptions: parserOptions})
}
 ...
 * })
 */
shorthandReaders.readTsv = function (filePath, opts_, cb) {
  var parserOptions
  if (typeof cb === 'undefined') {
    cb = opts_
  } else {
  ...
  readers.readData(filePath, {parser: parsers.tsv, parserOptions: parserOptions}, cb)
}
 ...
 * console.log(data) // Json data with casted values
 */
shorthandReaders.readTsvSync = function (filePath, opts_) {
  var parserOptions
  if (typeof opts_ !== 'undefined') {
    parserOptions = _.isFunction(opts_) ? {map: opts_} : opts_
  }
  return readers.readDataSync(filePath, {parser: parsers.tsv, parserOptions: parserOptions})
}
 ...
 * })
 */
shorthandReaders.readPsv = function (filePath, opts_, cb) {
  var parserOptions
  if (typeof cb === 'undefined') {
    cb = opts_
  } else {
  ...
  readers.readData(filePath, {parser: parsers.psv, parserOptions: parserOptions}, cb)
}
 ...
 * console.log(data) // Json data with casted values
 */
shorthandReaders.readPsvSync = function (filePath, opts_) {
  var parserOptions
  if (typeof opts_ !== 'undefined') {
    parserOptions = _.isFunction(opts_) ? {map: opts_} : opts_
  }
  return readers.readDataSync(filePath, {parser: parsers.psv, parserOptions: parserOptions})
}
 ...
 * })
 */
shorthandReaders.readTxt = function (filePath, opts_, cb) {
  var parserOptions
  if (typeof cb === 'undefined') {
    cb = opts_
  } else {
  ...
  readers.readData(filePath, {parser: parsers.txt, parserOptions: parserOptions}, cb)
}
 ...
 * console.log(data) // string data with values replaced
 */
shorthandReaders.readTxtSync = function (filePath, opts_) {
  var parserOptions
  if (typeof opts_ !== 'undefined') {
    parserOptions = _.isFunction(opts_) ? {map: opts_} : opts_
  }
  return readers.readDataSync(filePath, {parser: parsers.txt, parserOptions: parserOptions})
}
 ...
 * })
 */
shorthandReaders.readYaml = function (filePath, opts_, cb) {
  var parserOptions
  if (typeof cb === 'undefined') {
    cb = opts_
  } else {
  ...
  readers.readData(filePath, {parser: parsers.yaml, parserOptions: parserOptions}, cb)
}
 ...
 * console.log(data) // json data with `height` values doubled
 */
shorthandReaders.readYamlSync = function (filePath, opts_) {
  var parserOptions
  if (typeof opts_ !== 'undefined') {
    parserOptions = _.isFunction(opts_) ? {map: opts_} : opts_
  }
  return readers.readDataSync(filePath, {parser: parsers.yaml, parserOptions: parserOptions})
}
 ...
 * })
 */
shorthandReaders.readAml = function (filePath, opts_, cb) {
  var parserOptions
  if (typeof cb === 'undefined') {
    cb = opts_
  } else {
  ...
  readers.readData(filePath, {parser: parsers.aml, parserOptions: parserOptions}, cb)
}
 ...
 * console.log(data) // json data with height multiplied by 2
 */
shorthandReaders.readAmlSync = function (filePath, opts_) {
  var parserOptions
  if (typeof opts_ !== 'undefined') {
    parserOptions = _.isFunction(opts_) ? {map: opts_} : opts_
  }
  return readers.readDataSync(filePath, {parser: parsers.aml, parserOptions: parserOptions})
}
