...
var parsers = {
  json: function (str, readOptions) {
    ...
    return json_parser(str, readOptions.reviver, readOptions.filename)
  },
  csv: dsv.csvParse,
  tsv: dsv.tsvParse,
 ...
 * @param {Object} [options.readOptions] Settings to be passed to `parse-json` library: https://www.npmjs.com/package/parse-json
 * @param {Function} [options.readOptions.reviver] Prescribes how the value originally produced by parsing is transformed, before being returned. See JSON.parse docs for more: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/JSON/parse#Using_the_reviver_parameter
 * @param {String} [options.readOptions.filename] Filename displayed in the error message.
 * @param {String|RegExp|Array<String>|Array<RegExp>} options.include if given a string, return files that have that string as their extension. If given a Regular Expression, return the file that matches the pattern. Can also take a list of both. List matching behavior is described in `includeAll`.
